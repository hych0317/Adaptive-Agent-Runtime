"""Deeply immutable JSON types owned by the LLM integration layer."""
...
class LLMModel(BaseModel):
    """Base model for immutable LLM integration snapshots."""
    ...
    def model_copy(
        ...
        *,
        ...
        """Return a validated copy so updates preserve deep immutability."""
